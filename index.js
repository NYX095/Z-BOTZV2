...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:NYX\n' //Ini Nama kontak lu
            + 'ORG: Owner 1;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6281216465289:+62 81216465289\n'  //ini kontak/nomor lu
            + 'END:VCARD'
...
const vcard1 = 'BEGIN:VCARD\n' // JAN DI GANTI
            ...
            + 'ORG:Owner 2;\n' // GANTI AJA
            + 'TEL;type=CELL;type=VOICE;waid=62895704368804:+62 895-7043-68804\n' // JAN DI GANTI TOD
            + 'END:VCARD' // JAN DI GANTI
        
numbernye = '0@s.whatsapp.net'
fake = 'Z-BOTZ' //Ini fake
prefix = '#' // All Prefix Gayss
blocked = []   
limitawal = 99999 //limit
memberlimit = 1 //maksimal member limit
cr1 = '*By NYX X YUSUFZ*'
freply = '*Yamhaha Wahyu :v*'
cr = '*NYX X YUSUFZ*' //fake reply
LoLKey = "yusuf01ch1b917cApi" // BELI SU?
TobzKey = "291F6uRDLIhlSpHp1hOy" //APIKEY TOBZ
XteamKey = "8d78801c391ee421" //BELI SU
AnggaKey = "AnggaGanz" // itu Di bawah Desk yt gw
namo = 'NYX X YUSUFZ' //Bisa ubah / ga tapi hati hati
ator = '+6281216465289' //author
fakereply = 'Z-BOTZ' //fake reply
fakereply1 = 'ZBOTZ' //fakereply

/******** OWNER NUMBER**********/
const ownerNumber = ["6281216465289@s.whatsapp.net"]   //ganti nomor lu! 
const pacarNumber = ["62895704368804@s.whatsapp.net"]  //ganti nomor lu!  
/************************************/
...
break
		case 'sewabot1':
                ...
                if (!isRegistered) return reply(ind.noregis())
                    ...
                    Angga.sendMessage('62812164652892@s.whatsapp.net', options, text, {quoted: mek})
		...
		case 'batal1':
                ...
                if (!isRegistered) return reply(ind.noregis())
                    ...
                    Angga.sendMessage('6281216465289@s.whatsapp.net', options, text, {quoted: mek})
...
ow = "6281216465289@s.whatsapp.net"
daftarnye = `
@----------DAFTAR SEWA----------@
...
break
                     ...
                     break
                     case 'credits':
			const sokl = "6281216465289@s.whatsapp.net"
	...
	break
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6281216465289@s.whatsapp.net', fee)
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6281216465289 20`)
		...
		case 'cuttly':
				...
				case 'pornhub':
					...
					var porn = gh.split("/")[0];
					var hub = gh.split("/")[1];
					if (args.length < 1) return reply(`ã€Œâ—ã€Contoh : ${prefix}pornhub Z-BOTZ/Hub`)
					reply(ind.wait())
				...
				case 'googletext':
					...
					if (args.length < 1) return reply(`ã€Œâ—ã€Contoh : ${prefix}googletext Z-BOTZ/gans/abiezz`)
					reply(ind.wait())
...
//dappa gay
	...
	break
		...
		case 'ttp':
                ...
                if (isBanned) return reply(ind.baned())
                if (!isRegistered) return reply(ind.noregis())
                if (args.length < 2) return reply(`Mau Spamchat ke siapa? Contoh: ${prefix}spamchat 6281216465289 Oy ajc`)
...
─────────────────────`
		...
		case 'pinterest':
           ...
           case 'glitchtext':
					...
					var gli = gh.split("/")[0];
					var tch = gh.split("/")[1];
					if (args.length < 1) return reply(`ã€Œâ—ã€Contoh : ${prefix}glitchtext NYX/Gans`)
					reply(ind.wait())
...
─────────────────────`
       ...
       if (!isRegistered) return reply(ind.noregis())
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					Angga.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group Z-BOTZ :\n\n\`\`\``
					no = 0
		...
		case 'menu':
		    ...
		    ow = "6281216465289@s.whatsapp.net" //Ganti Nomor Mu
		    cuy = "6281216465289@s.whatsapp.net" // Ganti nomor mu
                    menusu = `
...
case 'bneon':
		...
		case 'info':
					...
					ow = "6281216465289@s.whatsapp.net"
					uptime = process.uptime()
					teks = `➽ *Name Bot* : wa.me/6281216465289\n➽ *Owner* : @${ow.split('@')[0]}\n➽ *Prefix* : | ${prefix} |\n➽ *Total Block* : ${blocked.length}\n➽ *Bot Aktif* : ${kyun(uptime)}\n➽\n➽ *ɢʀᴜᴘ* : coming soon\n➽ *ꜱᴘᴇᴄɪᴀʟ ᴛʜᴀɴᴋꜱ ᴛᴏ* :\n➽ Allah ꜱᴡᴛ\n➽ Fxc7\n➽ MhankBarBars\n➽ Ampibi\n➽ Ramlan\n➽ Dennis\n➽  Anker`
		...
		case 'hargapremium':
					...
					break
		case 'buypremium':
					Angga.sendMessage(from, 'Ingin membeli premium?\nHarap hubungi kami : wa.me/6281216465289',MessageType.text, { quoted: mek} )
					break
		...
		case 'tagall2':
					...
					mentions(`┌───「Z-BOTZ TAG」───`+ teks +'└───「 *_Pxc7_* 」────', members_id, true)
					break
		case 'clearall':
					if (!isOwner) return reply(ind.ownerb())
